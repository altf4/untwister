...
python:
	...
	g++ -I$(PYTHON) -I$(BOOST_INC) -c -fPIC py-untwister.cpp
	g++ -shared -Wl,--export-dynamic untwister.o -L$(BOOST_LIB) -lboost_python -L/usr/lib/python2.7/config -lpython2.7 -o untwister.so
