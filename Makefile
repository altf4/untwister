# Standard flags
CPPFLAGS = -std=gnu++11 -O3 -g3 -Wall -c -fmessage-length=0 -MMD
...
# Make the binary
	...
	g++ -std=gnu++11 -O3 -o "untwister" ./prngs/GlibcRand.o ./prngs/Mt19937.o ./prngs/Ruby.o ./PRNGFactory.o ./untwister.o 
